clc;
NumberOfUsers = 44;% please enter number of user equipments
NumberOfUsersArray = zeros(1, NumberOfUsers);
B = 50*10^6;  % Hz 
Pt = 1; %watt
N0 = 10^(-17);    %noise density watt/Hz (-210 dBm/Hz)
PowerMatrix = dlmread('data5/power44.txt',' ');
