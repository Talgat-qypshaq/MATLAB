...
clc;
QPSK_SIC_4 = dlmread('data7/Java-QAM-4-SIC.txt',' ');
QPSK_PIC_4 = dlmread('data7/Java-QAM-4-PIC.txt',' ');
QPSK_SIC_16 = dlmread('data7/Java-QAM-16-SIC.txt',' ');
QPSK_PIC_16 = dlmread('data7/Java-QAM-16-PIC.txt',' ');
