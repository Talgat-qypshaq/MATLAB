...
QPSK_SIC_4  = dlmread('data7/Java-Threads-QAM-4-SIC.txt',' ');
QPSK_PIC_4  = dlmread('data7/Java-Threads-QAM-4-PIC.txt',' ');
QPSK_SIC_16 = dlmread('data7/Java-Threads-QAM-16-SIC.txt',' ');
QPSK_PIC_16 = dlmread('data7/Java-Threads-QAM-16-PIC.txt',' ');

UEs = dlmread('data7/UEs_Java.txt',' ');
